...
export interface TranslationSet {
  ...
  resetToZeroHint: string;
  resetToStartHint: string;
  settings: string;
  copy: string;
  help: string;
  donate: string;
  ...
  detailsDesc: string;
  tagsTitle: string;
  tagsList: { code: string; desc: string }[];
  save: string;
  close: string;
  saveAndUpdate: string;
  helpTitle: string;
  helpStep1: string;
  helpStep2: string;
  helpStep3: string;
  sourcesTitle: string;
  sourcesList: { code: string; desc: string }[];
  understand: string;
  donateTitle: string;
  donateThai: string;
  donateForeign: string;
  timeSettingsTitle: string;
  timeSettingsMinutes: string;
  timeSettingsSeconds: string;
  logoPathTitle: string;
  logoPathDesc: string;
  logoPathHint: string;
  changelogTitle: string;
  changelogContent: string;
  toastLoadFileFirst: string;
  toastMatchNotFound: string;
  toastLoaded: string;
  toastSuccess: string;
  toastSwapped: string;
  ...
  toastScoreReset: string;
  toastSaved: string;
  toastObsError: string;
  toastObsSuccess: string;
...
export const translations: Record<string, TranslationSet> = {
    ...
    en: {
        ...
        toastObsSuccess: "Connected to OBS successfully",
    ...
    th: {
        ...
        toastObsSuccess: "เชื่อมต่อ OBS สำเร็จ",
    ...
    lo: {
        ...
        toastObsSuccess: "ເຊື່ອມຕໍ່ OBS ສຳເລັດ",
    ...
    km: {
        ...
        sourcesList: [
            ...
            { code: 'time_counter', desc: '- **Text (GDI+)** សម្រាប់កម្មវិធីកំណត់ពេលវេលា' },
        ...
        changelogContent: `
            <ul class="changelog-list">
                ...
                <li><h5>ជំនាន់ 2.4</h5>
                    <ul>
                        <li>ការកែប្រែ UI ដ៏ធំសម្រាប់ការគ្រប់គ្រងកម្មវិធីកំណត់ម៉ោងដោយផ្អែកលើមតិកែលម្អ។</li>
        ...
        toastObsSuccess: "ភ្ជាប់ទៅ OBS បានជោគជ័យ",
    ...
    'pt-br': {
        ...
        toastObsSuccess: "Conectado ao OBS com sucesso",
    ...
    es: {
            ...
            <ul class="changelog-list">
                <li><h5>Versión 2.5</h5>
                    <ul>
                        ...
                        <li>Se agregó una color secundario para cada equipo.</li>
                    </ul>
                </li>
        ...
        toastSuccess: "Éxito",
        toastSwapped: "Equipes cambiados",
        ...
        toastObsSuccess: "Conectado a OBS con éxito",
